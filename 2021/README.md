...
There is a possibility that the icon name they provide on their site is inaccurate or outdated. If you copied the icon code correctly but the icon isn't showing up, go to [git.new/basicons-2021-list](https://git.new/basicons-2021-list) and try to find the correct name for the icon.  
